...
import style from "./govtJobDesc.module.css";
import Link from "next/link";
import DescTable from "@/components/DescTable/DescTable";

const GovtJobDescription = () => {
    ...
    <div>
      <div>
        <div className={style.info}>
          <h3>Name of Post: </h3>
          <p>
            SSC Junior Engineer JE Civil / Electrical / Mechanical Exam 2023
            Apply Online for 1327 Post
          </p>
        </div>
        <div className={style.info}>
      ...
      <DescTable
        ...
        rows={[
          ...
          { label: "SC/ST/PH", value: "₹00" },
          { label: "Ex-Servicemen/Departmental candidates", value: "₹00" },
          {
            label: "Payment",
            value: "Pay Fee Mode through Credit Card, Debit Card and Net Banking",
          },
        ]}
      />
      <DescTable
...
export default GovtJobDescription;
